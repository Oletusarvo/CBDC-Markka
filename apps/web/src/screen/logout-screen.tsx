...
export function LogoutScreen() {
  ...
  return (
    <Modal title={"Logout"} onClose={() => navigate("/auth/overview")}>
      <div className='flex flex-col gap-2 w-full'>
        <p className='text-slate-500'>Are you sure you want to log out?</p>
        {status === "error" ? <ErrorMessage>Logout failed!</ErrorMessage> : null}
